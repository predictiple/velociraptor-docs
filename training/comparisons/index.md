...
Velociraptor is a powerful forensic tool with many parsers, analysis
modules and features. When new users are introduced to Velociraptor it
is sometimes difficult to know where to start!

Many users have been using other popular tools before trying
...
1. Introduce people more familiar with these traditional tools to the
   Velociraptor equivalent artifacts.

2. Provide a comparison of Velociraptor's features vs. other
   tools. Many people are unaware of all the functionality present in
   Velociraptor and these pages summarize it in a high level way.

3. These comparisons helps the Velociraptor team to understand any
   gaps in Velociraptor's capabilities so they can be remediated in
   future.
