...
tools:
 - name: Hayabusa-4.0.0
   url: https://github.com/Yamato-Security/hayabusa/releases/download/v4.0.0/hayabusa-4.0.0-win-x64-live-response.zip
   expected_hash: ab65bf3310cfa1b3baa383843546913b2ec18a2144688bfac0acb0eb1205a8c6
   version: 4.0.0
...
sources:
 - name: Upload
   query: |
        ...
        FROM Artifact.Generic.Utils.FetchBinary(ToolName="Hayabusa-4.0.0", IsExecutable=FALSE)
        ...
        LET HayabusaExe <= TmpDir + '\\hayabusa-4.0.0-win-x64.exe'
